...
export const QuizProvider: React.FC = ({ children }) => {
  ...
  return (showLoader ? <div className="flex flex-col justify-center items-center h-screen bg-blue-50">
    <Loader type="Oval" color="#3B82F6" height={100} width={100} />
    <h2 className="ml-4 mt-4 text-blue-900 text-3xl font-bold tracking-widest">Loading...</h2>
  </div> : 
